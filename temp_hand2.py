...
"""
new="""
.battle-hand .hand-list { display:flex; gap:6px; max-width:720px; overflow-x:hidden; overflow-y:hidden; justify-content:flex-start; padding-bottom:4px; }
.battle-hand .hand-card { position:relative; width:90px; min-height:140px; background: rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.12); border-radius:8px; padding:6px 8px; color:#eaf6ff; font-size:12px; box-shadow: 0 6px 12px rgba(0,0,0,.25); transform: rotate(0deg); transition: transform .12s ease, box-shadow .12s ease; flex-shrink:0; }
.battle-hand .hand-card:hover { transform: translateY(-6px) scale(1.02); box-shadow: 0 10px 16px rgba(0,0,0,.35); z-index:5; }
"""
if old not in css:
    raise SystemExit('hand list block not found')
